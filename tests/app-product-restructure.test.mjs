...
assert.equal(favicon?.getAttribute("href"), "assettrail-mark.svg?v=20260819-logo-v2");
...
assert.equal(brandMark?.getAttribute("src"), "assettrail-mark.svg?v=20260819-logo-v2");
