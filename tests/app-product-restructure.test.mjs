...
assert.equal(favicon?.getAttribute("href"), "assettrail-mark.svg?v=20260820-vault-v1");
...
assert.equal(brandMark?.getAttribute("src"), "assettrail-mark.svg?v=20260820-vault-v1");
...
assert.match(brandMarkSvg, /<rect width="128" height="128" rx="31" fill="#2563EB"\/>/);
assert.match(brandMarkSvg, /M64 22c5 0 10 2 13 6l27 31/);
assert.match(brandMarkSvg, /fill="#FFFFFF"/);
assert.doesNotMatch(brandMarkSvg, /stroke=/);
