...
assert.equal(favicon?.getAttribute("href"), "assettrail-mark.svg?v=20260819-logo-v3");
...
assert.equal(brandMark?.getAttribute("src"), "assettrail-mark.svg?v=20260819-logo-v3");
...
assert.equal((brandMarkSvg.match(/stroke-width="12"/g) || []).length, 2);
assert.equal((brandMarkSvg.match(/cx="81"/g) || []).length, 2);
assert.equal((brandMarkSvg.match(/r="6"/g) || []).length, 2);
