...
assert.equal(favicon?.getAttribute("href"), "assettrail-mark.svg?v=20260819-logo-v4");
...
assert.equal(brandMark?.getAttribute("src"), "assettrail-mark.svg?v=20260819-logo-v4");
...
assert.match(brandMarkSvg, /viewBox="0 0 128 128"/);
assert.match(brandMarkSvg, /M18 106 47 20l29 86M31 66h62/);
assert.match(brandMarkSvg, /M76 20h34M93 20v86/);
assert.equal((brandMarkSvg.match(/stroke-width="15"/g) || []).length, 2);
assert.equal((brandMarkSvg.match(/cx="78"/g) || []).length, 2);
assert.equal((brandMarkSvg.match(/r="7\.5"/g) || []).length, 2);
assert.equal((brandMarkSvg.match(/fill="#2563eb"/g) || []).length, 2);
