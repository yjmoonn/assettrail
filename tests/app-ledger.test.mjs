...
const appCode = [readFileSync("ledger-engine.js", "utf8"), [readFileSync("retirement-engine.js", "utf8"), [readFileSync("performance-source-engine.js", "utf8"), readFileSync("app.js", "utf8")].join("\n")].join("\n")].join("\n");
...
assert.equal(
  window.localStorage.getItem(`${STORAGE_KEY}:migration-backup:v4-to-v9`),
  legacyRaw
);
